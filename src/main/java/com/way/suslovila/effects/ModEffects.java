...
public class ModEffects {
    ...
    public static final RegistryObject<MobEffect> WATER_SHIELD = MOD_EFFECTS.register("water_shield_effect", ()-> new WaterShieldEffect(MobEffectCategory.BENEFICIAL, 52105209));
