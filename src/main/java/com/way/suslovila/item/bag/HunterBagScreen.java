...
public class HunterBagScreen extends AbstractContainerScreen<ContainerHunterBag> {
    private static final ResourceLocation CONTAINER_TEXTURE = new ResourceLocation(MysticalCreatures.MOD_ID, "textures/gui/bag.png");

    public HunterBagScreen(ContainerHunterBag p_99240_, Inventory p_99241_, Component p_99242_) {
