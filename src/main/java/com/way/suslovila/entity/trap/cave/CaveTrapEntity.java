package com.way.suslovila.entity.trap.cave;
...
public class CaveTrapEntity extends PathfinderMob implements IAnimatable {
    private int timer;
    private boolean previousCapt;
    private AnimationFactory factory = new AnimationFactory(this);

    public CaveTrapEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        boolean now = ((CaveTrapEntity) event.getAnimatable()).captured();
        /*if (now && !previousCapt) {
            previousCapt = now;
